  ...
  <div>
    <div class="service_warp">
      ...
      <div class="immediately_way">
        ...
        <div class="immediately_way_item">
          <img src="@img/service/QQ.png" alt class="immediately_way_item_img" />
